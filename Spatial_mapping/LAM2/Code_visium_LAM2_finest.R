...
LAM2.data <- Read10X_h5("LAM2_filt_feat_bc_matrix.h5")
...
#____--------------------------------------------------
# Load cell types file
cell_types <- read.csv("azimuth_pred_LAM2_finest.tsv", sep="\t")
head(cell_types)
...
cell_types[cell_types == "Plasma"] <- "Plasma_CD8_P_DCs"
cell_types[cell_types == "CD8"] <- "Plasma_CD8_P_DCs"
cell_types[cell_types == "P_DCs"] <- "Plasma_CD8_P_DCs"
